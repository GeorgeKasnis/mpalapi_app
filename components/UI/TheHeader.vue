<template>
    <header class="h-16 sticky top-0 tablet:hidden flex items-center bg-main z-50">
    ...
    <header class="tablet:flex h-16  sticky top-0 hidden items-center bg-main z-50">
